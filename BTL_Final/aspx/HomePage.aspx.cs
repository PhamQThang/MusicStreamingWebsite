...
namespace BTL_Final.aspx
{
    public partial class HomePage : System.Web.UI.Page
    {
        ...
        //sap xep
        protected void btnSapXep(object sender, EventArgs e)
        {
            if(IsPostBack)
            {
                List<MusicFrame> list = array.Cast<MusicFrame>().ToList();
                list.Sort((a, b) => string.Compare(a.nameMusic, b.nameMusic));
                array.Clear();
                array = new ArrayList(list);
                Application["LMF"] = array;
                Response.Redirect("HomePage.aspx");
