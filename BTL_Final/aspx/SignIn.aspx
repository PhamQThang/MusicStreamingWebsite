    ...
    <form id="form1" runat="server">
        ...
        <div class="login">
            ...
            <div style="text-align:center">
                <p class="forgot_form"><a href="ForGot.aspx" style="display:none; color:mediumblue; text-decoration:none" id="forgot_form">Quên mật khẩu</a></p>
                <p style="color:#000" class="signup_form">Chưa có tài khoản? <a style="text-decoration:none; color:mediumblue" href="SignUp.aspx" id="switch_to_register">Đăng ký</a></p>
                <div style="padding-top: 12px;">
                    <a style="text-decoration:none; color:mediumblue; font-size:14px;" href="HomePage.aspx">Quay về Trang Chủ!</a>
                </div>
            </div>
        </div>
        </div>
