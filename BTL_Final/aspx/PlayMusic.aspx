...
<body>
                            ...
                            <div class="content-music">
                                ...
                                <div class="music-control">
                                    ...
                                    <div class="item heart" id="heart" style="color:white;border:1px solid white">
                                        ...
                                        <p id="countHeart" runat="server" style="margin-top:-10px; ">0</p>
                                    </div>
                                </div>
                            </div>
                            <!-- list-music -->
    ...
    <script>
        ...
        var musicBanner = document.getElementsByClassName("music-banner")
        ...
        window.onload = function () {
            ...
            countDown = setInterval(runCountDown, 1000);
                ...
                /*for (let j = 0; j < musicFrame.length; j++) {
                    if (musicName[j].innerHTML === namePlaySong.innerHTML) {
                        musicBanner[j].style.backgroundColor = "#281449e6"
                    } else {
                        musicBanner[j].style.backgroundColor = "unset"
                    }
                }*/
                setSongArr()
