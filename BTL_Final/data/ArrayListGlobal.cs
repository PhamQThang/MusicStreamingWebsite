...
namespace BTL_Final.data
{
    public class ArrayListGlobal
    {
        ...
        public void addData()
        {
            ...
            arrayList.Add(new MusicFrame("Cứ Chill Thôi", "Chillies", new TimeSpan(0, 4, 40), "Việt Nam", 0, "Cuchillthoi.jpg", "CuChillThoi.mp3", "suniHaLinh.jfif"));
            ...
            arrayList.Add(new MusicFrame("Ghé Qua", "TaynguyenSound", new TimeSpan(0, 4, 28), "Việt Nam", 0, "GheQua.jpg", "ghequa.mp3", "TaynguyenSoundvàtofutns.jfif"));
            //Trung Quốc
        ...
        {
            arrayList = new ArrayList();
            arrayList.Add(new User("QuangThang@gmail.com", "PhamQuangThang", "Quang Thắng", "Thang1@", "123456789"));
            arrayList.Add(new User("1@gmail.com", "Thang1", "Nguyễn Trần Trung Quân", "Thang1@", "123456789"));
